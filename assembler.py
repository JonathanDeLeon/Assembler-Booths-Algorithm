...
# global vars
input_file = "booth.asm"
output_file = "booth.obj"
instructions = []
...
# Assemble instructions based on a given file
    ...
    for line in inputFile:
        ...
        if len(instruction) != 0:
            ...
            if rtype:
                ...
                #print "Instruction is memory:", dtype.groupdict()
...
# Ouput instruction list of integers to binary
...
if __name__ == "__main__":
    ...
    try:
        ...
        print(str(e))
        sys.exit(1)
    # Output instructions to binary
    try:
        outfile = open(output_file, 'w')
        output_to_binary(instructions, outfile)
        outfile.close()
    except IOError,e:
        #print >> sys.stderr, "Unable to open output file %s" % output_file
